...
public class DeleteCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String hbl="delete from CategoryMaster where category_id = "+categoryId;
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Deleting Category</title>");            
            out.println("</head>");
            out.println("<body>");
             if(result<0){
            ...
            out.println("<h3 align=center>Category Deleted<h3>");
             }
            out.println("</body>");
            out.println("</html>");
        }
