...
public class DeleteSubCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String hbl="delete from SubCategoryMaster where sub_category_id = "+subCategoryId;
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Deleting Sub Category</title>");            
            out.println("</head>");
            out.println("<body>");
             if(result<0){
            ...
            out.println("<h3 align=center>Sub Category Deleted<h3>");
             }
            out.println("</body>");
            out.println("</html>");
        }
