...
public class EditBrand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String hbl="update BrandMaster B set brand_name = '"+newName+"' where brand_id = "+brandId;
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Edit Brand</title>");            
            out.println("</head>");
            out.println("<body>");
             if(result<0){
            ...
            out.println("<h3 align=center>Brand Edited<h3>");
             }
            out.println("</body>");
            out.println("</html>");
        }
